...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=BusinessCard::class, mappedBy="user")
     */
    ...
    /**
     * @return Collection|BusinessCard[]
     */
    ...
    public function addBusinessCard(BusinessCard $businessCard): self
    {
    ...
    public function removeBusinessCard(BusinessCard $businessCard): self
    {
        if ($this->businessCards->contains($businessCard)) {
            $this->businessCards->removeElement($businessCard);
            // set the owning side to null (unless already changed)
            if ($businessCard->getUser() === $this) {
                $businessCard->setUser(null);
            }
        }
